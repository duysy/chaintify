...
import { get as getArtist } from "../../apis/extends/artist/get_artist";
import { create_or_update as create_or_updateArtist, TCreateArtist } from "../../apis/extends/artist/post_artist";
...
export default function Profile() {
  ...
  const mutationArtist = useMutation([""], (data: any) => create_or_updateArtist(data), {
    onSuccess: () => {
      setOption("REVIEW");
    },
  });
