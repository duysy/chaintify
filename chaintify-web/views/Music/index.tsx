    ...
    <Wrap>
      <Box display="flex">
        <Box sx={{ flex: 3 }}>
          ...
          >
            BLACKPINK là nhóm nhạc nữ Hàn Quốc 4 thành viên đến từ công ty YG
            Entertainment. Debut vào năm 2016, nhóm nổi tiếng và trở thành một
            trong những nhóm nhạc KPop thành công nhất... XEM THÊM
          </Typography>
